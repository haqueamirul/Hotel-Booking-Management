...
{
   $type_id=$_GET['delete_room_type'];
    $deleteQuery = "DELETE FROM room_type WHERE room_type_id=$type_id";
    if (mysqli_query($connection, $deleteQuery)) {
        header('Location: index.php?room_type');
    } else {
        echo "Error updating record: " . mysqli_error($connection);
    }
}
...
{
   $complain_id=$_GET['delete_complaint'];
    $deleteQuery = "DELETE FROM complaint WHERE id=$complain_id";
    if (mysqli_query($connection, $deleteQuery)) {
        header('Location: index.php?complain');
    } else {
        echo "Error updating record: " . mysqli_error($connection);
    }
}
